...
export const skillText = [
    {
        title: "끊임없는 열정과 끈기를 통한 결과중심적 개발자",
        desc: "저는 언제나 최선을 다하는 개발자로서 끊임없는 열정과 끈기를 통해 좋은 결과를 이루어낼 수 있는 능력을 소유하고 있습니다. 무엇을 하든지 최선을 다하면 좋은 결과가 따라온다고 믿습니다. 제가 새로운 프로젝트나 기술에 처음으로 접하더라도, 저의 끈기와 열정은 어떤 어려움도 극복할 수 있는 원동력이 됩니다. 낯설더라도 하나씩 차근차근 단계를 밟아가면 언제나 좋은 결과가 따라왔습니다. 새로운 기술을 습득하거나 복잡한 문제에 직면하더라도, 저는 체계적인 학습과 문제 해결을 통해 한 걸음 한 걸음 더 나아가려고 노력합니다. 이러한 접근 방식은 프로젝트에서 성과를 창출하는 데 큰 도움이 되었습니다. 뿐만 아니라, 혹여나 실패하더라도 그 경험이 미래의 경험의 밑바탕이 되어 더 좋은 결과를 가져왔습니다. 실패는 항상 성공의 씨앗을 뿌리는 과정 중 하나로 보며, 실패를 통해 배운 교훈을 다음 프로젝트나 도전에 적용하여 더 나은 결과를 이끌어냅니다. 이를 통해 저는 지속적인 성장과 발전을 추구하며 항상 새로운 도전에 적극적으로 나서는 개발자로서의 역량을 키우고 있습니다. 제가 가진 열정, 끈기, 그리고 실패를 통한 성장 경험을 바탕으로, 어떠한 프로젝트에도 헌신하고 최고의 결과를 이루어내고자 합니다. 이러한 열정과 능력을 통해 회사나 팀의 성공을 위해 끊임없이 노력할 것을 약속드립니다."
    },
    {
        title: "기술적 열정으로 무한한 학습을 추구하는 개발자",
        desc: "저는 끊임없는 학습과 기술적 열정으로 어떤 도전에도 도전적으로 접근하는 개발자입니다. 새로운 기술과 도구에 대한 열정은 저를 끊임없이 발전하고 성장하게 만듭니다. 무슨 일을 하든 항상 최신 트렌드와 새로운 기술 동향을 주시하고, 이를 효율적으로 활용하기 위해 학습하고 적용하는 것을 즐깁니다. 처음 접하는 어떤 기술이나 프레임워크를 습득하는 데 전혀 거부감이 없으며, 이러한 접근 방식은 여러 프로젝트에서 다양한 기술 스택을 성공적으로 적용하는 데 도움이 되었습니다. 새로운 언어나 플랫폼에 대한 공부를 즐기고, 이를 통해 프로젝트의 요구 사항에 가장 적합한 기술을 선택하며 최상의 결과를 도출합니다. 또한, 어떤 어려움도 극복하기 위해 끈기를 발휘합니다. 이러한 열정과 능력을 통해 미래의 기술적 도전에 대비하고, 지속적인 성장을 추구하여 언제나 최고의 결과를 이끌어내기 위해 노력합니다."
    },
    {
        title: "문제 해결과 분석 능력을 바탕으로 결과를 창출하는 개발자",
        desc: "저는 뛰어난 문제 해결과 분석 능력을 활용하여 어떤 도전이라도 효과적으로 대처하며 원하는 결과를 도출합니다. 어떤 상황에서도 핵심 문제를 파악하고 꼼꼼하게 분석하는 과정을 즐기며, 이를 통해 최적의 해결 방법을 찾아냅니다. 새로운 도전에 직면하더라도, 저는 정보 수집과 분석을 체계적으로 진행하고 합리적인 결정을 내리는 데 주력합니다. 데이터 분석, 알고리즘 설계, 혁신적인 기술 활용을 통해 문제를 해결하며, 이러한 방식은 다양한 프로젝트에서 성과를 이루는데 도움이 되었습니다."
    }
]
...
export const siteText = [
    {
        ...
        code: "https://github.com/Coconutpalmtreeisland/vite-project",
        view: "https://coconut-vite-project.netlify.app",
        info: [
            "site coding",
    ...
    },
    {
        ...
        code: "https://github.com/Coconutpalmtreeisland/react-project2023",
        view: "https://coconut-vite-project.netlify.app",
        info: [
            "site coding",
            "production period : two days",
...
export const contactText = [
    {
        link: "mailto:adorableness1215@naver.com",
        title: "E-mail : adorableness1215@naver.com",
    },
];
...
export const footerText = [
    {
        ...
        link: "https://github.com/Coconutpalmtreeisland",
    },
    {
        title: "react",
        desc: "리액트로 사이트를 만듭니다.",
        link: "https://github.com/Coconutpalmtreeisland/react-webpage",
    },
    {
        title: "vue",
        desc: "뷰로 사이트를 만듭니다.",
        link: "https://github.com/Coconutpalmtreeisland/vue-webpage",
    }
];